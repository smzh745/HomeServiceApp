...
import kotlinx.android.synthetic.main.activity_on_way_worker.*

@SuppressLint("SetTextI18n")
class OnWayWorkerActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_on_way_worker)
        title = getString(R.string.on_the_way)
        if (intent.getStringExtra("type").equals("worker_accept", true)) {
    ...
    private fun initView() {
        ...
        workDesp.text = "A worker will be there to resolve " + itemsString[8] + " at your place"
